...
func Test_options(t *testing.T) {
	...
	doguClientsetInterfaceMock.EXPECT().DoguV2().Return(doguV2InterfaceMock)
	doguV2ClientMock := newMockDoguV2Client(t)
	doguV2RestartMock := newMockDoguRestartInterface(t)
