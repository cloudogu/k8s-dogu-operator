...
func newWarpMenuEntryClientSet(config *rest.Config) (warpMenuEntryV1.ApiV1Interface, error) {
	return warpMenuEntryV1.NewForConfig(config)
}
...
func NewWarpMenuEntryInterface(warpMenuEntryClientSet warpMenuEntryV1.ApiV1Interface, operatorConfig *config.OperatorConfig) warpMenuEntryV1.WarpMenuEntryInterface {
