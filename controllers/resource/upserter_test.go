...
func TestNewUpserter(t *testing.T) {
	...
	mockResourceGenerator := mocks.NewDoguResourceGenerator(t)
...
func Test_upserter_UpsertDoguDeployment(t *testing.T) {
	...
	t.Run("fail on error when generating resource", func(t *testing.T) {
		...
		generator.EXPECT().CreateDoguDeployment(testCtx, doguResource, dogu).Return(nil, assert.AnError)
		upserter := upserter{
			client:    mockClient,
			generator: generator,
		}
	...
	t.Run("fail when upserting", func(t *testing.T) {
		...
		generator := mocks.NewDoguResourceGenerator(t)
		generator.EXPECT().CreateDoguDeployment(testCtx, doguResource, dogu).Return(readLdapDoguExpectedDeployment(t), nil)
		upserter := upserter{
			client:    mockClient,
			generator: generator,
		}
	...
	t.Run("successfully upsert deployment", func(t *testing.T) {
		...
		generator.EXPECT().CreateDoguDeployment(testCtx, doguResource, dogu).Return(generatedDeployment, nil)
		upserter := upserter{
			client:    testClient,
			generator: generator,
		}
