...
type mockConstructorTestingTnewMockExposePortAdder interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockExposePortAdder(t mockConstructorTestingTnewMockExposePortAdder) *mockExposePortAdder {
