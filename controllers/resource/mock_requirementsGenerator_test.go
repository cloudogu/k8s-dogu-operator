...
type mockConstructorTestingTnewMockRequirementsGenerator interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockRequirementsGenerator(t mockConstructorTestingTnewMockRequirementsGenerator) *mockRequirementsGenerator {
