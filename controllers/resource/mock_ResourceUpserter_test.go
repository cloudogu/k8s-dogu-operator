...
type mockConstructorTestingTNewMockResourceUpserter interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockResourceUpserter(t mockConstructorTestingTNewMockResourceUpserter) *MockResourceUpserter {
