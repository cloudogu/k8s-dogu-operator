...
type mockConstructorTestingTnewMockDoguConfigGetter interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockDoguConfigGetter(t mockConstructorTestingTnewMockDoguConfigGetter) *mockDoguConfigGetter {
