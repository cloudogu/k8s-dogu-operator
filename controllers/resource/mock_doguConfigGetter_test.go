...
func (_m *mockDoguConfigGetter) Get(ctx context.Context, name config.SimpleDoguName) (config.DoguConfig, error) {
...
func (_c *mockDoguConfigGetter_Get_Call) Run(run func(ctx context.Context, name config.SimpleDoguName)) *mockDoguConfigGetter_Get_Call {
...
func (_c *mockDoguConfigGetter_Get_Call) RunAndReturn(run func(context.Context, config.SimpleDoguName) (config.DoguConfig, error)) *mockDoguConfigGetter_Get_Call {
	_c.Call.Return(run)
	return _c
}
