...
func NewCompositeDependencyValidator(version *core.Version, fetcher cloudogu.LocalDoguFetcher) *CompositeDependencyValidator {
	...
	doguDependencyValidator := NewDoguDependencyValidator(fetcher)
