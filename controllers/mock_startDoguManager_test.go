...
type mockConstructorTestingTnewMockStartDoguManager interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockStartDoguManager(t mockConstructorTestingTnewMockStartDoguManager) *mockStartDoguManager {
