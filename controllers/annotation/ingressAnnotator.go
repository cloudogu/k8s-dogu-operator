...
func (i IngressAnnotator) AppendIngressAnnotationsToService(service *corev1.Service, additionalIngressAnnotations doguv2.IngressAnnotations) error {
...
func appendAdditionalIngressAnnotations(service *corev1.Service, ingressAnnotations doguv2.IngressAnnotations) error {
