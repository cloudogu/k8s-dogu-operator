...
type mockConstructorTestingTnewMockSensitiveDoguConfig interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockSensitiveDoguConfig(t mockConstructorTestingTnewMockSensitiveDoguConfig) *mockSensitiveDoguConfig {
