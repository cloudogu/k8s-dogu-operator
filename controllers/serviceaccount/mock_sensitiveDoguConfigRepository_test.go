...
type mockConstructorTestingTnewMockSensitiveDoguConfigRepository interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockSensitiveDoguConfigRepository(t mockConstructorTestingTnewMockSensitiveDoguConfigRepository) *mockSensitiveDoguConfigRepository {
