...
type mockConstructorTestingTNewMockServiceAccountCreator interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockServiceAccountCreator(t mockConstructorTestingTNewMockServiceAccountCreator) *MockServiceAccountCreator {
