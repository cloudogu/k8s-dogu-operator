...
type mockConstructorTestingTnewMockSensitiveDoguConfigSetter interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockSensitiveDoguConfigSetter(t mockConstructorTestingTnewMockSensitiveDoguConfigSetter) *mockSensitiveDoguConfigSetter {
