...
type mockConstructorTestingTnewMockCommandExecutor interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockCommandExecutor(t mockConstructorTestingTnewMockCommandExecutor) *mockCommandExecutor {
