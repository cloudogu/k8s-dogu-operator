...
type mockConstructorTestingTnewMockServiceAccountApiClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockServiceAccountApiClient(t mockConstructorTestingTnewMockServiceAccountApiClient) *mockServiceAccountApiClient {
