...
type mockConstructorTestingTnewMockSensitiveDoguConfigGetter interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockSensitiveDoguConfigGetter(t mockConstructorTestingTnewMockSensitiveDoguConfigGetter) *mockSensitiveDoguConfigGetter {
