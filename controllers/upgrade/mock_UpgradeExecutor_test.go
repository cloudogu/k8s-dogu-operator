...
type mockConstructorTestingTNewMockUpgradeExecutor interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockUpgradeExecutor(t mockConstructorTestingTNewMockUpgradeExecutor) *MockUpgradeExecutor {
