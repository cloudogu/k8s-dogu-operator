...
type mockConstructorTestingTnewMockDoguHealthChecker interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockDoguHealthChecker(t mockConstructorTestingTnewMockDoguHealthChecker) *mockDoguHealthChecker {
