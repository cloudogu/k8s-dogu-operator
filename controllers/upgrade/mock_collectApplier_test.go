...
type mockConstructorTestingTnewMockCollectApplier interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockCollectApplier(t mockConstructorTestingTnewMockCollectApplier) *mockCollectApplier {
