...
func (_m *mockLogSink) Error(err error, msg string, keysAndValues ...any) {
	var _ca []interface{}
...
func (_c *mockLogSink_Error_Call) RunAndReturn(run func(error, string, ...any)) *mockLogSink_Error_Call {
	_c.Run(run)
	return _c
}

// Info provides a mock function with given fields: level, msg, keysAndValues
func (_m *mockLogSink) Info(level int, msg string, keysAndValues ...any) {
	var _ca []interface{}
...
func (_c *mockLogSink_Info_Call) RunAndReturn(run func(int, string, ...any)) *mockLogSink_Info_Call {
	_c.Run(run)
	return _c
}
...
func (_m *mockLogSink) WithValues(keysAndValues ...any) logr.LogSink {
	var _ca []interface{}
	_ca = append(_ca, keysAndValues...)
	ret := _m.Called(_ca...)
	...
	var r0 logr.LogSink
	if rf, ok := ret.Get(0).(func(...any) logr.LogSink); ok {
		r0 = rf(keysAndValues...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(logr.LogSink)
...
func (_c *mockLogSink_WithValues_Call) RunAndReturn(run func(...any) logr.LogSink) *mockLogSink_WithValues_Call {
	_c.Call.Return(run)
	return _c
}
