...
type mockConstructorTestingTnewMockRequeueHandler interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockRequeueHandler(t mockConstructorTestingTnewMockRequeueHandler) *mockRequeueHandler {
