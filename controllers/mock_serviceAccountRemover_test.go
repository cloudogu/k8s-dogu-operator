...
type mockConstructorTestingTnewMockServiceAccountRemover interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockServiceAccountRemover(t mockConstructorTestingTnewMockServiceAccountRemover) *mockServiceAccountRemover {
