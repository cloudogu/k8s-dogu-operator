...
func (_m *mockResourceUpserter) UpsertDoguNetworkPolicies(ctx context.Context, doguResource *v2.Dogu, dogu *core.Dogu, doguService *v1.Service) error {
...
func (_c *mockResourceUpserter_UpsertDoguNetworkPolicies_Call) Run(run func(ctx context.Context, doguResource *v2.Dogu, dogu *core.Dogu, doguService *v1.Service)) *mockResourceUpserter_UpsertDoguNetworkPolicies_Call {
	_c.Call.Run(func(args mock.Arguments) {
