...
// RemoveAllFromComponents provides a mock function with given fields: ctx, dogu
func (_m *mockServiceAccountRemover) RemoveAllFromComponents(ctx context.Context, dogu *core.Dogu) error {
	ret := _m.Called(ctx, dogu)

	if len(ret) == 0 {
		panic("no return value specified for RemoveAllFromComponents")
	}
...
// mockServiceAccountRemover_RemoveAllFromComponents_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RemoveAllFromComponents'
type mockServiceAccountRemover_RemoveAllFromComponents_Call struct {
	*mock.Call
}

// RemoveAllFromComponents is a helper method to define mock.On call
//   - ctx context.Context
//   - dogu *core.Dogu
func (_e *mockServiceAccountRemover_Expecter) RemoveAllFromComponents(ctx interface{}, dogu interface{}) *mockServiceAccountRemover_RemoveAllFromComponents_Call {
	return &mockServiceAccountRemover_RemoveAllFromComponents_Call{Call: _e.mock.On("RemoveAllFromComponents", ctx, dogu)}
}

func (_c *mockServiceAccountRemover_RemoveAllFromComponents_Call) Run(run func(ctx context.Context, dogu *core.Dogu)) *mockServiceAccountRemover_RemoveAllFromComponents_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*core.Dogu))
	})
	return _c
...
func (_c *mockServiceAccountRemover_RemoveAllFromComponents_Call) Return(_a0 error) *mockServiceAccountRemover_RemoveAllFromComponents_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *mockServiceAccountRemover_RemoveAllFromComponents_Call) RunAndReturn(run func(context.Context, *core.Dogu) error) *mockServiceAccountRemover_RemoveAllFromComponents_Call {
	_c.Call.Return(run)
	return _c
}
