...
type mockConstructorTestingTnewMockLocalDoguDescriptorRepository interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockLocalDoguDescriptorRepository(t mockConstructorTestingTnewMockLocalDoguDescriptorRepository) *mockLocalDoguDescriptorRepository {
