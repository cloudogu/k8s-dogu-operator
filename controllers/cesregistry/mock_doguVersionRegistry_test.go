...
type mockConstructorTestingTnewMockDoguVersionRegistry interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockDoguVersionRegistry(t mockConstructorTestingTnewMockDoguVersionRegistry) *mockDoguVersionRegistry {
