...
type mockConstructorTestingTNewMockResourceDoguFetcher interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockResourceDoguFetcher(t mockConstructorTestingTNewMockResourceDoguFetcher) *MockResourceDoguFetcher {
