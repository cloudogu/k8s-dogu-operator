...
type mockConstructorTestingTnewMockRemoteDoguDescriptorRepository interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockRemoteDoguDescriptorRepository(t mockConstructorTestingTnewMockRemoteDoguDescriptorRepository) *mockRemoteDoguDescriptorRepository {
