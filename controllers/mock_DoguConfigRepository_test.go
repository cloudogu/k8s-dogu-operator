...
func (_m *MockDoguConfigRepository) Delete(ctx context.Context, name config.SimpleDoguName) error {
...
func (_c *MockDoguConfigRepository_Delete_Call) Run(run func(ctx context.Context, name config.SimpleDoguName)) *MockDoguConfigRepository_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *MockDoguConfigRepository) Get(ctx context.Context, name config.SimpleDoguName) (config.DoguConfig, error) {
	ret := _m.Called(ctx, name)
...
func (_c *MockDoguConfigRepository_Get_Call) Run(run func(ctx context.Context, name config.SimpleDoguName)) *MockDoguConfigRepository_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(config.SimpleDoguName))
	})
	return _c
