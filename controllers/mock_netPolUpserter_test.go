...
func (_m *mockNetPolUpserter) UpsertDoguNetworkPolicies(ctx context.Context, doguResource *v2.Dogu, dogu *core.Dogu) error {
...
//   - dogu *core.Dogu
func (_e *mockNetPolUpserter_Expecter) UpsertDoguNetworkPolicies(ctx interface{}, doguResource interface{}, dogu interface{}) *mockNetPolUpserter_UpsertDoguNetworkPolicies_Call {
	return &mockNetPolUpserter_UpsertDoguNetworkPolicies_Call{Call: _e.mock.On("UpsertDoguNetworkPolicies", ctx, doguResource, dogu)}
}

func (_c *mockNetPolUpserter_UpsertDoguNetworkPolicies_Call) Run(run func(ctx context.Context, doguResource *v2.Dogu, dogu *core.Dogu)) *mockNetPolUpserter_UpsertDoguNetworkPolicies_Call {
...
func (_c *mockNetPolUpserter_UpsertDoguNetworkPolicies_Call) RunAndReturn(run func(context.Context, *v2.Dogu, *core.Dogu) error) *mockNetPolUpserter_UpsertDoguNetworkPolicies_Call {
	_c.Call.Return(run)
	return _c
}
