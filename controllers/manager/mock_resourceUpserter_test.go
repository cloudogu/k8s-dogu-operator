...
func (_m *mockResourceUpserter) UpsertDoguNetworkPolicies(ctx context.Context, doguResource *v2.Dogu, dogu *core.Dogu, hasIngress bool) error {
...
//   - dogu *core.Dogu
//   - hasIngress bool
func (_e *mockResourceUpserter_Expecter) UpsertDoguNetworkPolicies(ctx interface{}, doguResource interface{}, dogu interface{}, hasIngress interface{}) *mockResourceUpserter_UpsertDoguNetworkPolicies_Call {
	return &mockResourceUpserter_UpsertDoguNetworkPolicies_Call{Call: _e.mock.On("UpsertDoguNetworkPolicies", ctx, doguResource, dogu, hasIngress)}
}

func (_c *mockResourceUpserter_UpsertDoguNetworkPolicies_Call) Run(run func(ctx context.Context, doguResource *v2.Dogu, dogu *core.Dogu, hasIngress bool)) *mockResourceUpserter_UpsertDoguNetworkPolicies_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *mockResourceUpserter_UpsertDoguNetworkPolicies_Call) RunAndReturn(run func(context.Context, *v2.Dogu, *core.Dogu, bool) error) *mockResourceUpserter_UpsertDoguNetworkPolicies_Call {
	_c.Call.Return(run)
	return _c
}
