...
type mockConstructorTestingTnewMockConfigMapInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockConfigMapInterface(t mockConstructorTestingTnewMockConfigMapInterface) *mockConfigMapInterface {
