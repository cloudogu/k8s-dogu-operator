...
type mockConstructorTestingTnewMockDoguRecursiveHealthChecker interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockDoguRecursiveHealthChecker(t mockConstructorTestingTnewMockDoguRecursiveHealthChecker) *mockDoguRecursiveHealthChecker {
