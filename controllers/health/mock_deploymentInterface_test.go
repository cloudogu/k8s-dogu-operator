...
type mockConstructorTestingTnewMockDeploymentInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockDeploymentInterface(t mockConstructorTestingTnewMockDeploymentInterface) *mockDeploymentInterface {
