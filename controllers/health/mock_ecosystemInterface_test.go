...
type mockConstructorTestingTnewMockEcosystemInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockEcosystemInterface(t mockConstructorTestingTnewMockEcosystemInterface) *mockEcosystemInterface {
