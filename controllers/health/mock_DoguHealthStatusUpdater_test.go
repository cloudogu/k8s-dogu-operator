...
type mockConstructorTestingTNewMockDoguHealthStatusUpdater interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockDoguHealthStatusUpdater(t mockConstructorTestingTNewMockDoguHealthStatusUpdater) *MockDoguHealthStatusUpdater {
