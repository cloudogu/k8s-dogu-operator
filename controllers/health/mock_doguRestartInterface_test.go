...
type mockConstructorTestingTnewMockDoguRestartInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockDoguRestartInterface(t mockConstructorTestingTnewMockDoguRestartInterface) *mockDoguRestartInterface {
