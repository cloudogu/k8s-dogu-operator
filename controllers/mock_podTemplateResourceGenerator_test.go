...
type mockConstructorTestingTnewMockPodTemplateResourceGenerator interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockPodTemplateResourceGenerator(t mockConstructorTestingTnewMockPodTemplateResourceGenerator) *mockPodTemplateResourceGenerator {
