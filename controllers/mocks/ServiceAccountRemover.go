...
// RemoveServiceAccounts provides a mock function with given fields: ctx, doguResource, dogu
func (_m *ServiceAccountRemover) RemoveServiceAccounts(ctx context.Context, doguResource *v1.Dogu, dogu *core.Dogu) error {
