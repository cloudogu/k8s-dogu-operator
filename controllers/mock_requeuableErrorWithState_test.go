...
type mockConstructorTestingTnewMockRequeuableErrorWithState interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockRequeuableErrorWithState(t mockConstructorTestingTnewMockRequeuableErrorWithState) *mockRequeuableErrorWithState {
