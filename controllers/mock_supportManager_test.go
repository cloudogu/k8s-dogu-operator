...
type mockConstructorTestingTnewMockSupportManager interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockSupportManager(t mockConstructorTestingTnewMockSupportManager) *mockSupportManager {
