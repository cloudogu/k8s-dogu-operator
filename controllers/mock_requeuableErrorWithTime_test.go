...
type mockConstructorTestingTnewMockRequeuableErrorWithTime interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockRequeuableErrorWithTime(t mockConstructorTestingTnewMockRequeuableErrorWithTime) *mockRequeuableErrorWithTime {
