...
func (_m *MockFileExtractor) ExtractK8sResourcesFromContainer(ctx context.Context, k8sExecPod ExecPod) (map[string]string, error) {
	ret := _m.Called(ctx, k8sExecPod)

	var r0 map[string]string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ExecPod) (map[string]string, error)); ok {
		return rf(ctx, k8sExecPod)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ExecPod) map[string]string); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, ExecPod) error); ok {
...
func (_c *MockFileExtractor_ExtractK8sResourcesFromContainer_Call) Run(run func(ctx context.Context, k8sExecPod ExecPod)) *MockFileExtractor_ExtractK8sResourcesFromContainer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(ExecPod))
	})
	return _c
}
...
func (_c *MockFileExtractor_ExtractK8sResourcesFromContainer_Call) RunAndReturn(run func(context.Context, ExecPod) (map[string]string, error)) *MockFileExtractor_ExtractK8sResourcesFromContainer_Call {
	_c.Call.Return(run)
	return _c
}

type mockConstructorTestingTNewMockFileExtractor interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockFileExtractor(t mockConstructorTestingTNewMockFileExtractor) *MockFileExtractor {
