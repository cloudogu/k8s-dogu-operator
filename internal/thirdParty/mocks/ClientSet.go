...
func (_m *ClientSet) CoordinationV1alpha1() coordinationv1alpha1.CoordinationV1alpha1Interface {
	ret := _m.Called()
...
// ClientSet_CoordinationV1alpha1_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CoordinationV1alpha1'
type ClientSet_CoordinationV1alpha1_Call struct {
	*mock.Call
}

// CoordinationV1alpha1 is a helper method to define mock.On call
func (_e *ClientSet_Expecter) CoordinationV1alpha1() *ClientSet_CoordinationV1alpha1_Call {
	return &ClientSet_CoordinationV1alpha1_Call{Call: _e.mock.On("CoordinationV1alpha1")}
}

func (_c *ClientSet_CoordinationV1alpha1_Call) Run(run func()) *ClientSet_CoordinationV1alpha1_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *ClientSet_CoordinationV1alpha1_Call) Return(_a0 coordinationv1alpha1.CoordinationV1alpha1Interface) *ClientSet_CoordinationV1alpha1_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ClientSet_CoordinationV1alpha1_Call) RunAndReturn(run func() coordinationv1alpha1.CoordinationV1alpha1Interface) *ClientSet_CoordinationV1alpha1_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *ClientSet) ResourceV1alpha3() v1alpha3.ResourceV1alpha3Interface {
	ret := _m.Called()
...
// ClientSet_ResourceV1alpha3_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ResourceV1alpha3'
type ClientSet_ResourceV1alpha3_Call struct {
	*mock.Call
}

// ResourceV1alpha3 is a helper method to define mock.On call
func (_e *ClientSet_Expecter) ResourceV1alpha3() *ClientSet_ResourceV1alpha3_Call {
	return &ClientSet_ResourceV1alpha3_Call{Call: _e.mock.On("ResourceV1alpha3")}
}

func (_c *ClientSet_ResourceV1alpha3_Call) Run(run func()) *ClientSet_ResourceV1alpha3_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *ClientSet_ResourceV1alpha3_Call) Return(_a0 v1alpha3.ResourceV1alpha3Interface) *ClientSet_ResourceV1alpha3_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ClientSet_ResourceV1alpha3_Call) RunAndReturn(run func() v1alpha3.ResourceV1alpha3Interface) *ClientSet_ResourceV1alpha3_Call {
	_c.Call.Return(run)
	return _c
}
...
type ClientSet_StoragemigrationV1alpha1_Call struct {
	*mock.Call
}
...
func (_e *ClientSet_Expecter) StoragemigrationV1alpha1() *ClientSet_StoragemigrationV1alpha1_Call {
	return &ClientSet_StoragemigrationV1alpha1_Call{Call: _e.mock.On("StoragemigrationV1alpha1")}
}
