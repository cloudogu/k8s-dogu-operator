...
type mockConstructorTestingTNewRequirementsGenerator interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewRequirementsGenerator(t mockConstructorTestingTNewRequirementsGenerator) *RequirementsGenerator {
